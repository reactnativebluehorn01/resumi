    ...
    <div>
      <div className="header">
        <p style={{ textAlign: "center" }}>
          {" "}
          <strong>{contentUse.header.first_name}</strong>{" "}
          <strong>{contentUse.header.last_name}</strong> ,{" "}
          <strong>{contentUse.header.job_title}</strong>{" "}
        </p>
        <p style={{ textAlign: "center" }}>
          {contentUse.header.address}, {contentUse.header.city} ,{" "}
          {contentUse.header.postal_code},{contentUse.header.country},
      ...
      <>
        ...
        <Row className="row">
          ...
          <Col span={13}>
            {" "}
            {contentUse.education.degree} ,{content.education.school}
          </Col>
        ...
        <Row className="row">
          <Col span={7}></Col>
          <Col span={13}>
            description {content.education.education_description}
          </Col>
          <Col span={4}></Col>
        </Row>
      </>
      ...
      <Row className="row">
        <Col span={24}>
          <strong>EMPLOYEMNT HISTORY</strong>
        </Col>
      </Row>
      <Row className="row">
        <Col span={7}>
          <strong>
            {content.professional2.date1 ? content.professional2.date1 : ""} -{" "}
            {content.professional2.date2 ? content.professional2.date2 : ""}
          </strong>
        </Col>
        <Col span={13}>
          {content.professional2.jobTitle ? content.professional2.jobTitle : ""}{" "}
          ,{" "}
          {content.professional2.employer ? content.professional2.employer : ""}{" "}
        </Col>
        <Col span={4}>
          {content.professional2.city ? content.professional2.city : ""}{" "}
        </Col>
      </Row>
      <Row className="row">
        <Col span={7}></Col>
        <Col span={13}>
          {content.professional2.professionalDesription
            ? content.professional2.professionalDesription
            : ""}{" "}
        </Col>
        <Col span={4}></Col>
            ...
            <Col span={13}>
              {
                content.extraCurricularActivity
                  .extraCurricularActivity_description
              }
            </Col>
            <Col span={4}></Col>
          </Row>
      ...
      <Row className="row">
        ...
        <Col span={10}>
          {content.skills.skillName} {content.skills.level}
        </Col>
          ...
          <Row className="row">
            ...
            <Col span={17}>
              {content.refrences.referent
                ? content.refrences.referent + " , " + content.refrences.phone
                : ""}
            </Col>
          </Row>
          <hr className="divideLine" />
      ...
      {content.addSection.internship ? (
        <>
          ...
          <Row className="row">
            <Col span={7}>
              <strong>
                {content.intrenship.startDate
                  ? content.intrenship.startDate
                  : ""}{" "}
                - {content.intrenship.endDate ? content.intrenship.endDate : ""}
              </strong>
            </Col>
            <Col span={13}>
              {content.intrenship.jobTitle ? content.intrenship.jobTitle : ""} ,{" "}
              {content.intrenship.employer ? content.intrenship.employer : ""}{" "}
            </Col>
            <Col span={4}>
              {content.intrenship.city ? content.intrenship.city : ""}{" "}
            </Col>
          </Row>
          <Row className="row">
            <Col span={7}></Col>
            <Col span={13}>
              {content.intrenship.intrenship_description
                ? content.intrenship.intrenship_description
                : ""}{" "}
            </Col>
            <Col span={4}></Col>
